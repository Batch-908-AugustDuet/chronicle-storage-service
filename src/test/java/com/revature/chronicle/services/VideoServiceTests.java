...
public class VideoServiceTests {
    ...
    public void shouldReturnAListOfAllVideos(){
        Video video = new Video(1,"www.video.com", "Title", "A test video",new Date(),"",new ArrayList<Tag>());
    ...
    public void shouldReturnAVideoById(){
        Video video = new Video(6, "www.video.com", "Title", "A test video", new Date(), "", new ArrayList<Tag>());
    ...
    public void shouldReturnOnlyVideosThatMatchAllGivenTags(){
        ...
        Video video1 = new Video(1,"http://video1.com", "Title","A description",new Date(),"",tags1);
        Video video2 = new Video(2,"http://video2.com", "Title","A description",new Date(),"",tags2);
    ...
    public void shouldReturnAnEmptyListIfTagsAreEmpty(){
        ...
        Video video1 = new Video(1,"http://video.com", "Title","A description",new Date(),"",tags1);
        Video video2 = new Video(2,"http://video.com", "Title","A description",new Date(),"",tags2);

...
public class NoteServiceTests {
    ...
    public void shouldReturnAListOfAllNotes(){
        ...
        notes.add(new Note(1,"www.note.com", "Title","A description",new Date(), "", new ArrayList<Tag>()));
    ...
    public void shouldReturnANoteById(){
        Note note = new Note(1,"www.note.com", "Title","a description",new Date(),"", new ArrayList<Tag>());
    ...
    public void shouldReturnOnlyNotesThatMatchAllGivenTags(){
        ...
        Note note1 = new Note(1,"http://note.com", "Title","A description",new Date(),"",tags1);
        Note note2 = new Note(2,"http://note.com", "Title","A description",new Date(),"",tags2);
